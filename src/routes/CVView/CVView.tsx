            ...
            <div className="cv-wrapper">
                <div className="cv">
                    ...
                    <div className="cv__short-bio">
                        ...
                        <div className="cv__short-bio__info">
                            ...
                            <p className="cv__short-bio__info__email">
                                ...
                                <a href={`mailto:{tempData.email}`}
                                   className="cv__short-bio__info__email__link">{student.email}</a>
                            </p>
                        ...
                        <div className="cv__short-bio__controls">
                            <form action="" className="cv__short-bio__controls__form">
                                <input className="cv__short-bio__controls__btn" value="Brak zainteresowania"
                                       onClick={handleStatusAv}/>
                                <input className="cv__short-bio__controls__btn" value="Zatrudniony"
                    ...
                    <div className="cv__main-bio">
                        ...
                        <div className="cv__main-bio__content">
                            <div className="cv__main-bio__content__stars-container">
                                <div className="cv__main-bio__content__stars-container__title-container">
                                    <p className="cv__main-bio__content__stars-container__title-container-title">Ocena
                                        przejścia kursu</p>
                                </div>
                                <div className="cv__main-bio__content__stars-container__stars">
                                    <p className="cv__main-bio__content__stars-container__stars__rating">
                                        <span
                                            className="cv__main-bio__content__stars-container__stars__rating__rate">{student.courseCompletion}</span>
                                        /5
                                    </p>
                            ...
                            <div className="cv__main-bio__content__stars-container">
                                <div className="cv__main-bio__content__stars-container__title-container">
                                    <p className="cv__main-bio__content__stars-container__title-container-title">Ocena
                                        aktywności i zaangażowania na kursie</p>
                                </div>
                                <div className="cv__main-bio__content__stars-container__stars">
                                    <p className="cv__main-bio__content__stars-container__stars__rating">
                                        <span
                                            className="cv__main-bio__content__stars-container__stars__rating__rate">{student.courseEngagment}</span>
                                        /5
                                    </p>
                            ...
                            <div className="cv__main-bio__content__stars-container">
                                <div className="cv__main-bio__content__stars-container__title-container">
                                    <p className="cv__main-bio__content__stars-container__title-container-title">Ocena
                                        kodu w projekcie własnym</p>
                                </div>
                                <div className="cv__main-bio__content__stars-container__stars">
                                    <p className="cv__main-bio__content__stars-container__stars__rating">
                                        <span
                                            className="cv__main-bio__content__stars-container__stars__rating__rate">{student.projectDegree}</span>
                                        /5
                                    </p>
                            ...
                            <div className="cv__main-bio__content__stars-container">
                                <div className="cv__main-bio__content__stars-container__title-container">
                                    <p className="cv__main-bio__content__stars-container__title-container-title">Ocena
                                        pracy w zespole w Scrum</p>
                                </div>
                                <div className="cv__main-bio__content__stars-container__stars">
                                    <p className="cv__main-bio__content__stars-container__stars__rating">
                                        <span
                                            className="cv__main-bio__content__stars-container__stars__rating__rate">{student.teamProjectDegree}</span>
                                        /5
                                    </p>
                        ...
                        <div className="cv__main-bio__title-container">
                            <p className="cv__main-bio__title-container__title">Oczekiwanie w stosunku do
                                zatrudnienia</p>
                        </div>
                        <div className="cv__main-bio__content">
                            <div className="cv__main-bio__content__expectation-container">
                                <div className="cv__main-bio__content__expectation-container__place">
                                    <p className="cv__main-bio__content__expectation-container__place-title">Preferowane
                                        miejsce pracy</p>
                                ...
                                <div className="cv__main-bio__content__expectation-container__city">
                                    <p className="cv__main-bio__content__expectation-container__city-title">Docelowe
                                        miasto gdzie chce pracować kandydat</p>
                                ...
                                <div className="cv__main-bio__content__expectation-container__contract">
                                    <p className="cv__main-bio__content__expectation-container__contract-title">Oczekiwany
                                        typ kontaktu</p>
                                ...
                                <div className="cv__main-bio__content__expectation-container__salary">
                                    <p className="cv__main-bio__content__expectation-container__salary-title">Oczekiwane
                                        wynagrodzenie miesięczne netto</p>
                                ...
                                <div className="cv__main-bio__content__expectation-container__agreement">
                                    <p className="cv__main-bio__content__expectation-container__agreement-title">Zgoda
                                        na odbycie bezpłatnych praktyk/stażu na początek</p>
                                ...
                                <div className="cv__main-bio__content__expectation-container__experience">
                                    <p className="cv__main-bio__content__expectation-container__experience-title">Komercyjne
                                        miesiące doświadczenia w programowaniu</p>
                        ...
                        <div className="cv__main-bio__content">
                            <div className="cv__main-bio__content__portfolio">
                                <a href="" className="cv__main-bio__content__portfolio__link">
                                    <span className="cv__main-bio__content__portfolio__icon"><FontAwesomeIcon
                                        icon={paperClipIconDefinition}/></span>
                                ...
                                <div className="cv__main-bio__content__scrum">
                                    {tempData.scrumLinks.map((link: string, i: number) => (
                                        <a href="" className="cv__main-bio__content__scrum__link" key={i}>
                                            <span className="cv__main-bio__content__scrum__icon"><FontAwesomeIcon
                                                icon={paperClipIconDefinition}/></span>
                                            {link}
                                        </a>
                                    ))}
                                ...
                                <div className="cv__main-bio__content__pass">
                                    {tempData.passLinks.map((link: string, i: number) => (
                                        <a href="" className="cv__main-bio__content__pass__link" key={i}>
                                            <span className="cv__main-bio__content__pass__icon"><FontAwesomeIcon
                                                icon={paperClipIconDefinition}/></span>
                                            {link}
                                        </a>
                                    ))}
